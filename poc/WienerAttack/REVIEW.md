...
Toàn bộ thuật toán chạy thời gian đa thức và rất nhanh trong thực tế.
...
- Hệ thống dùng \(e = 65537\) (nhỏ) **nhưng \(d\)** vẫn chuẩn, full-size (như trong hầu hết hệ thống hiện đại).
- Các kịch bản **partial key exposure**:
  - chỉ lộ một phần MSB/LSB của \(d\),
  - có một vài bit bị lật (bit flip),
...
- Hiện đại: chỉ cần tránh chọn \(d\) nhỏ, là gần như loại bỏ được rủi ro Wiener.
